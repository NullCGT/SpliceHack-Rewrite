...
des.engraving({ x = 27, y = 9, type = "burn", text = "alive inside, send help" });
des.engraving({ x = 27, y = 6, text = "E|bercth" });
...
local shk_demise = { {05,07},{09,05},{31,05},{30,14},{05,14},{10,13},{26,14},{27,13} }
shuffle(shk_demise)
...
des.engraving({ coord = shk_demise[4], type = "burn", text = "i'll be in my shop!" });
des.engraving({ coord = shk_demise[5], text = "oh no oh no oh no" });
des.engraving({ coord = shk_demise[6], text = "please send help" });
