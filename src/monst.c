 ...
 * for MON()
 */
#define LVL(lvl, mov, ac, mr, aln) lvl, mov, ac, 0, mr, aln
#define DRLVL(lvl, mov, ac, dr, mr, aln) lvl, mov, ac, dr, mr, aln
...
NEARDATA struct permonst mons_init[] = {
     ...
     * blobs
     */
    /* Blobs are characterized, in part, by their ability to shrug off large
       amounts of damage. */
    MON("acid blob", S_BLOB, DRLVL(1, 3, 8, 2, 0, 0), (G_GENO | 2),
    ...
    MON("quivering blob", S_BLOB, DRLVL(5, 1, 8, 8, 0, 0), (G_GENO | 2),
    ...
    MON("gelatinous cube", S_BLOB, DRLVL(6, 6, 8, 4, 0, 0), (G_GENO | 2),
    ...
    MON("warg", S_DOG, LVL(7, 12, 4, 0, -5), (G_GENO | G_SGROUP | 2),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        8, CLR_BROWN),
    MON("thought eater", S_DOG, DRLVL(7, 12, 2, 2, 0, -3), (G_GENO | G_SGROUP | 2),
    ...
    MON("hell hound pup", S_DOG, LVL(7, 12, 4, 20, -5),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        9, CLR_RED),
    MON("barghest", S_DOG, DRLVL(7, 12, 4, 4, 20, -7), (G_GENO | 1),
    ...
    MON2("hellcat", S_FELINE, DRLVL(12, 12, 6, 3, 0, 0), (G_HELL | G_GENO | 3),
      	A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4),
    ...
    MON("gremlin", S_GREMLIN, LVL(5, 12, 2, 25, -9), (G_GENO | 2),
        ...
        8, CLR_GREEN),
    MON("gargoyle", S_GREMLIN, DRLVL(6, 10, -4, 2, 0, -9), (G_GENO | 2),
        ...
        0, 8, CLR_BROWN),
    MON("winged gargoyle", S_GREMLIN, LVL(9, 15, -2, 4, 0, -12), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
    ...
    MON("deep one", S_HUMANOID, DRLVL(7, 9, 5, 4, 10, -5), (G_GENO | G_LGROUP | 2),
      	A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
      	  ATTK(AT_BITE, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("deeper one", S_HUMANOID, DRLVL(15, 12, 0, 5, 30, -7),
        (G_GENO | G_SGROUP | 2),
    ...
    MON("deepest one", S_HUMANOID, DRLVL(30, 15, -5, 6, 70, -9), (G_GENO | 1),
      	A(ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
    ...
    MON("redcap", S_IMP, DRLVL(10, 15, 2, 3, 30, 7), (G_GENO | 1),
     ...
     * jellies
     */
    MON("blue jelly", S_JELLY, DRLVL(4, 0, 8, 5, 10, 0), (G_GENO | 2),
    ...
    MON("spotted jelly", S_JELLY, DRLVL(5, 0, 8, 5, 10, 0), (G_GENO | 1),
    ...
    MON("ochre jelly", S_JELLY, DRLVL(6, 3, 8, 5, 20, 0), (G_GENO | 2),
    ...
    MON2("orc warlord", S_ORC, DRLVL(6, 5, 12, 2, 0, -5), (G_GENO | G_NOGEN),
     ...
     * piercers
     */
    MON("rock piercer", S_PIERCER, DRLVL(3, 1, 3, 2, 0, 0), (G_GENO | 4),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("iron piercer", S_PIERCER, DRLVL(5, 1, 0, 4, 0, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 3, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("glass piercer", S_PIERCER, DRLVL(7, 1, 0, 6, 0, 0), (G_GENO | 1),
    ...
    MON("diamond piercer", S_PIERCER, DRLVL(8, 1, 0, 8, 0, 0), (G_GENO | G_NOGEN),
    ...
    MON("god piercer", S_PIERCER, DRLVL(9, 1, 0, 10, 0, 3), (G_GENO | G_NOGEN),
    ...
    MON("grizzly bear", S_QUADRUPED, LVL(12, 12, 7, 0, 0), (G_GENO | 2),
        ...
        5, CLR_YELLOW),
    MON("hippo", S_QUADRUPED, DRLVL(10, 3, 2, 4, 0, 0), (G_GENO | G_SGROUP | 1),
    ...
    MON("mastodon", S_QUADRUPED, DRLVL(20, 12, 5, 4, 0, 0), (G_GENO | 1),
     ...
     * trappers, lurkers, &c
     */
    MON("lurker above", S_TRAPPER, DRLVL(10, 3, 3, 4, 0, 0), (G_GENO | 2),
    ...
    MON("trapper", S_TRAPPER, DRLVL(12, 3, 3, 4, 0, 0), (G_GENO | 2),
    ...
    MON("baby purple worm", S_WORM, LVL(8, 3, 5, 0, 0), G_GENO,
        ...
        9, CLR_MAGENTA),
    MON("long worm", S_WORM, DRLVL(9, 3, 5, 5, 10, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
...
struct permonst _mons2[] = {
    ...
    MON("leather golem", S_GOLEM, LVL(6, 6, 6, 0, 0), (G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID, M2_HOSTILE | M2_NEUTER, 0,
        7, HI_LEATHER),
    MON("wood golem", S_GOLEM, DRLVL(7, 3, 4, 1, 0, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("flesh golem", S_GOLEM, LVL(9, 8, 9, 30, 0), (1),
        ...
        10, CLR_RED),
    MON("clay golem", S_GOLEM, DRLVL(11, 7, 7, 4, 40, 0), (G_NOCORPSE | 1),
    ...
    MON("stone golem", S_GOLEM, DRLVL(14, 6, 5, 6, 50, 0), (G_NOCORPSE | 1),
    ...
    MON("silver golem", S_GOLEM, DRLVL(18, 8, 1, 6, 50, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1800, 0, MS_SILENT, MZ_LARGE), MR_SLEEP | MR_POISON | MR_ACID, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG, 0, 20, CLR_BRIGHT_CYAN),
    MON("iron golem", S_GOLEM, DRLVL(18, 6, 3, 6, 60, 0), (G_NOCORPSE | 1),
    ...
    MON("ruby golem", S_GOLEM, DRLVL(24, 12, 3, 6, 60, 0), (G_NOCORPSE | 1),
    ...
    MON("sapphire golem", S_GOLEM, DRLVL(28, 12, 3, 7, 60, 0), (G_NOCORPSE | 1),
        ...
        CLR_BRIGHT_CYAN),
    MON("steel golem", S_GOLEM, DRLVL(30, 15, 3, 8, 60, 0), (G_NOCORPSE | 1),
        ...
        CLR_BRIGHT_BLUE),
    /* Crystal golems -- The strongest foe in SpliceHack. */
    MON("crystal golem", S_GOLEM, DRLVL(32, 15, 3, 10, 60, 0), (G_NOCORPSE | 1),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON2("horned devil", S_DEMON, DRLVL(6, 9, -5, 3, 50, 11),
        (G_HELL | G_NOCORPSE | 2),
    ...
    MON2("erinys", S_DEMON, DRLVL(7, 12, 2, 3, 30, 10),
    ...
    MON2("barbed devil", S_DEMON, DRLVL(8, 12, 0, 3, 35, 8),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
    ...
    MON2("marilith", S_DEMON, DRLVL(7, 12, -6, 3, 80, -12),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
    ...
    MON2("bar-lgura", S_DEMON, 
        DRLVL(7, 15, -3, 3, 45, -9), (G_HELL | G_NOCORPSE | G_SGROUP | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
    ...
    MON2("vrock", S_DEMON, DRLVL(8, 12, 0, 3, 50, -9),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 11, CLR_RED),
    MON2("hezrou", S_DEMON, DRLVL(9, 6, -2, 3, 55, -10),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 12, CLR_RED),
    MON2("bone devil", S_DEMON, DRLVL(9, 15, -1, 3, 40, -9),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
    ...
    MON2("armanite", S_CENTAUR, DRLVL(9, 20, 2, 3, 10, -3), 
    ...
    MON2("ice devil", S_DEMON, DRLVL(11, 6, -4, 3, 55, -12),
        (G_HELL | G_NOCORPSE | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
    ...
    MON2("nalfeshnee", S_DEMON, DRLVL(11, 9, -1, 3, 65, -11),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
        ...
        M1_HUMANOID | M1_POIS, M2_STALK | M2_HOSTILE | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 15, CLR_RED),
    MON2("pit fiend", S_DEMON, DRLVL(13, 6, -3, 5, 65, -13),
        (G_HELL | G_NOCORPSE | 2),
    ...
    MON("sandestin", S_DEMON, DRLVL(13, 12, 4, 3, 60, -5),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON2("balrog", S_DEMON, DRLVL(16, 5, -2, 5, 75, -14), (G_HELL | G_NOCORPSE | 1),
    ...
    MON2("molydeus", S_DEMON, DRLVL(20, 12, -3, 4, 40, -10), (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4), 
     ...
     */
    MON2("Juiblex", S_DEMON, DRLVL(50, 3, 6, -7, 65, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON2("Zuggotomoy", S_DEMON, DRLVL(51, 5, 6, -4, 65, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON2("Buer", S_DEMON, DRLVL(52, 20, 6, -5, 70, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON2("Pazuzu", S_DEMON, DRLVL(53, 18, 6, -2, 65, 15),
    ...
    MON2("Kostchtchie", S_DEMON, DRLVL(54, 15, 6, 3, 30, -15),
    ...
    MON2("Yeenoghu", S_DEMON, DRLVL(56, 18, 6, -5, 80, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        MH_DEMON, 31, HI_LORD),
    MON2("Baphomet", S_DEMON, DRLVL(56, 15, 6, -5, 70, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_WANTSAMUL,
        MH_DEMON, 32, HI_LORD),
    MON2("Orcus", S_DEMON, DRLVL(66, 9, 6, -6, 85, -20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        36, HI_LORD),
    MON2("Geryon", S_DEMON, DRLVL(72, 3, 6, -3, 75, 15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
        ...
        M3_WANTSAMUL | M3_INFRAVISIBLE | M3_INFRAVISION, 
        MH_DEMON, 36, HI_LORD),
    MON2("Dispater", S_DEMON, DRLVL(78, 15, 6, -2, 80, 15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        M3_WANTSAMUL | M3_INFRAVISIBLE | M3_INFRAVISION,
        MH_DEMON, 40, HI_LORD),
    MON2("Malcanthet", S_DEMON, DRLVL(80, 15, 6, -6, 80, 15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        42, HI_LORD),
    MON2("Baalzebub", S_DEMON, DRLVL(89, 9, 6, -5, 85, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        MH_DEMON, 45, HI_LORD),
    MON2("Mephistopholes", S_DEMON, DRLVL(105, 12, 6, -17, 90, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        53, HI_LORD),
    MON2("Asmodeus", S_DEMON, DRLVL(105, 12, -7, 6, 90, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        M3_WANTSAMUL | M3_WAITFORU | M3_INFRAVISIBLE | M3_INFRAVISION,
        MH_DEMON, 53, HI_LORD),
    MON2("Demogorgon", S_DEMON, DRLVL(106, 15, -8, 15, 95, -20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
...
NEARDATA struct permonst montemplates[] = {
    ...
    MON("ironflesh", S_ANT, DRLVL(0, -2, 0, 6, 0, 0), (0),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(0, 0, 0, 0), 0, 0, 0L, M2_STRONG, 0, 2, 0),
    MON("elite", S_HUMAN, DRLVL(3, 2, -3, 2, 10, 0), (0),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
