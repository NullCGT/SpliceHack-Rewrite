...
NHSUBDIR="nh370.37-hdf"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/nh370.37-hdf/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-nh370.37-hdf"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-nh370.37-hdf"
